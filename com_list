...
if __name__ == "__main__":
        for port in COMPorts.get_com_ports().data:
            ...
            com=values=[port.device for port in COMPorts.get_com_ports().data]
            comdescript=values=[port.description for port in COMPorts.get_com_ports().data]
